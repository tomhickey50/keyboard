...
char comports[38][16]={"/dev/ttymxc4"};
...
void RS232_cputs(int comport_number, const char *text, int varlen)  /* sends a string to serial port */
{
  int i;
  /* printf("rs485h varlen = %d\n",varlen); */
  for(i=0; i<varlen; i++) 
  {
	RS232_SendByte(comport_number, text[i]);
  }
